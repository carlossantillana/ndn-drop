...
Tracer::Tracer(Drop& drop, const Options& options)
  : m_options(options)
{
  drop.afterData.connect(bind(&Tracer::onData, this, _1, _2));
  drop.afterNack.connect(bind(&Tracer::onNack, this, _1, _2, _3));
  drop.afterTimeout.connect(bind(&Tracer::onTimeout, this, _1));
}
